...
export default function Searchbox(props: Props) {
  return (
    <form onSubmit={props.onSubmit} className={cn('flex relative items-center justify-center h-10', props.className)}>
      ...
      <button type="button" className='px-4 py-[9px] bg-bkg-2 text-content-1 border border-gray-200 rounded-r-md focus:outline-none  hover:bg-gray-400 whitespace-nowrap h-full'>
        <IoSearch />
      </button>
    </form>
  )
